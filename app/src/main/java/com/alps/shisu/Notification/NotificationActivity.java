...
public class NotificationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarkM=findViewById(R.id.toolbar_notification);
        if (!isConnection(NotificationActivity.this))buildDialog(NotificationActivity.this).show();
        ...
        viewPagerkm=(ViewPager)findViewById(R.id.viewPagernotification);
        ...
        tabLayoutkm=(TabLayout)findViewById(R.id.tabLayoutnotification);
...
//    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        NotificationActivity.ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(NotificationActivity.this, DashBoard.class);
