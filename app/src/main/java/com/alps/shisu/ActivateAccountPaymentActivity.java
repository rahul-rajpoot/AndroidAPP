...
public class ActivateAccountPaymentActivity extends BaseActivity{
...
//            String url = "https://aplusmart.online/payment/appPay.aspx?id="+orderNo;
            String url = "https://aplusmart.online/payment/appPay.aspx?id="+ user.get(SessionManagement.KEY_USERNAME)+"&kid="+ kId;
