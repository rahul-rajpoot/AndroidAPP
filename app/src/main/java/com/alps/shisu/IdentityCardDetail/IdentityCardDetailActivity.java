...
public class IdentityCardDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_identity_card_detail);

        toolbarkM=findViewById(R.id.toolbar_identitydetail);
        if (!isConnection(IdentityCardDetailActivity.this))buildDialog(IdentityCardDetailActivity.this).show();
        setSupportActionBar(toolbarkM);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Identity Card Details");
        toolbarkM.setTitleTextColor(getResources().getColor(R.color.colorWhite));
        viewPagerkm=(ViewPager)findViewById(R.id.viewPageridentitydetail);
...
//                startActivity(intent);
        ...
        tabLayoutkm=(TabLayout)findViewById(R.id.tabLayoutidentitydetail);
...
//        AlertDialog.Builder builder=new AlertDialog.Builder(IdentityCardDetailActivity.this);
...
//    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        IdentityCardDetailActivity.ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFrag(new IdentityDetailFragment(), "");
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(IdentityCardDetailActivity.this, DashBoard.class);
