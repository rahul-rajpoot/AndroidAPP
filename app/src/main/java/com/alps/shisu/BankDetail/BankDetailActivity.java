package com.alps.shisu.BankDetail;
...
public class BankDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarkM=findViewById(R.id.toolbar_bankdetail);
        if (!isConnection(BankDetailActivity.this))buildDialog(BankDetailActivity.this).show();
        ...
        viewPagerkm=(ViewPager)findViewById(R.id.viewPagerbankdetail);
...
//                startActivity(intent);
            Intent ds = new Intent(BankDetailActivity.this, NetworkManagerActivity.class);
            ds.putExtra("nm", 1);
            startActivity(ds);
        });
        ...
        tabLayoutkm=(TabLayout)findViewById(R.id.tabLayoutbankdetail);
...
//    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        BankDetailActivity.ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFrag(new BankDetailFragment(), "");
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(BankDetailActivity.this, DashBoard.class);
