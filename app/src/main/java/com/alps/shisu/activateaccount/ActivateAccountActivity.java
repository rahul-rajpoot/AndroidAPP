...
public class ActivateAccountActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarkM=findViewById(R.id.toolbar_activate_account);
        if (!isConnection(ActivateAccountActivity.this))buildDialog(ActivateAccountActivity.this).show();
...
//        AlertDialog.Builder builder=new AlertDialog.Builder(ActivateAccountActivity.this);
...
//        adapter.addFrag(new ListPinFragment(), "List Pin");
        ...
        adapter.addFrag(new ActivateAccountFragment(), "");
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(ActivateAccountActivity.this, DashBoard.class);
