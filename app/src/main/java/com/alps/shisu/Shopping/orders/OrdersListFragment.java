...
public class OrdersListFragment extends Fragment implements View.OnClickListener {
    ...
    private static final String ARG_PARAM1 = "parparam2am1";
...
//      userName = "akumar";
        ...
        _orderStatusRadioGroup.setOnCheckedChangeListener((group, checkedId) -> {
            ...
            if (isChecked)
            {
                ...
                } else if(selectedType.equalsIgnoreCase("Pending")){
                    selectedStatus = "0";
                    callOnApplyButtonClick();
                } else if(selectedType.equalsIgnoreCase("Confirmed")){
                    selectedStatus = "1";
                    callOnApplyButtonClick();
                } else if(selectedType.equalsIgnoreCase("Rejected")){
                    selectedStatus = "2";
                    callOnApplyButtonClick();
                }
            }
...
//        https://api.aplusmart.online/DeveloperAPI/Orderlist/M/A345P3Mart/1/AP1298mAtr4340BtMN/startid/Purchase/-1/0/0
//        urls = ut.url + "Orderlist/" + ut.merchantid + ut.securtykey + "/"+userName+"/Purchase/"+selectedStatus+"/"+fromDate+"/"+toDate;
        urls = Config.url + "Orderlist/" + Config.merchantid +"/"+ Config.securtykey + "/"+userName+"/Purchase/"+selectedStatus+"/"+fromDate+"/"+toDate;
...
//                            orderItemDetails.setOrderDate(orderDate.replaceAll("/","-"));
