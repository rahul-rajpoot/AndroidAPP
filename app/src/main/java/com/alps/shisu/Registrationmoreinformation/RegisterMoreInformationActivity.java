...
public class RegisterMoreInformationActivity extends BaseActivity {
    TabLayout tabLayoutpf;
    ViewPager viewPagerpf;
    Toolbar toolbarpf;
    LinearLayout linearoutproflfooter1,linearoutdashfooter2,linearoutproflfooter4,linearoutproflfooter5;
    int page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_more_information);

        toolbarpf=findViewById(R.id.toolbar_moreinfo);
        if (!isConnection(RegisterMoreInformationActivity.this))buildDialog(RegisterMoreInformationActivity.this).show();
        ...
        viewPagerpf=(ViewPager)findViewById(R.id.viewPagermoreinfo);
...
//                startActivity(intent);
        ...
        tabLayoutpf=(TabLayout)findViewById(R.id.tabLayoutmoreinfo);
...
//        AlertDialog.Builder builder=new AlertDialog.Builder(RegisterMoreInformationActivity.this);
...
//    }
    ...
    private void setupViewPager(ViewPager viewPager) {
        RegisterMoreInformationActivity.ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFrag(new RegisterMoreInformationFragment(), "Registration Successful");
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(RegisterMoreInformationActivity.this, DashBoard.class);
