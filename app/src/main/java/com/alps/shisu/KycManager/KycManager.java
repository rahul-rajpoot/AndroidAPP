...
public class KycManager extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kyc_manager);
        toolbarkM=findViewById(R.id.toolbar_kycmanager);
        if (!isConnection(KycManager.this))buildDialog(KycManager.this).show();
        setSupportActionBar(toolbarkM);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("E-Pin Manager");
        toolbarkM.setTitleTextColor(getResources().getColor(R.color.colorWhite));
        viewPagerkm=(ViewPager)findViewById(R.id.viewPagerkycmanager);
...
//                startActivity(intent);
        ...
        tabLayoutkm=(TabLayout)findViewById(R.id.tabLayoutkycmanager);
...
//        AlertDialog.Builder builder=new AlertDialog.Builder(KycManager.this);
...
//        adapter.addFrag(new GeneratePinFragment(), "Generate Pin");
//        adapter.addFrag(new ListPinFragment(), "List Pin");

        adapter.addFrag(new GeneratePinFragment(), "Purchase E-Pin");
        adapter.addFrag(new ListPinFragment(), "List E-Pin");
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(KycManager.this, DashBoard.class);
