...
public class StarterPageActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SessionManagement.isFirtstTimeInstall(this)) {
            //The following code will execute after the 5 seconds.
            try {

                SessionManagement.setFirstTime(StarterPageActivity.this);
    ...
    private void showUpdateDialog() {
        ...
        builder.setPositiveButton("Update", (dialog, which) -> {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse
                    ("market://details?id=com.alps.aplusmart")));
            dialog.dismiss();
        });
    ...
    final ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == 1) {
                ...
                nextbtton.setOnClickListener(v -> {
                    Intent intent = new Intent(getApplicationContext(), LoginActivity.class);
                    startActivity(intent);
                    finish();
                });
