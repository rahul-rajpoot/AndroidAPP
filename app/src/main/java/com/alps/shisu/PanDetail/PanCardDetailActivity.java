package com.alps.shisu.PanDetail;
...
public class PanCardDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pan_card_detail);

        toolbarkM=findViewById(R.id.toolbar_pandetail);
        if (!isConnection(PanCardDetailActivity.this))buildDialog(PanCardDetailActivity.this).show();
        setSupportActionBar(toolbarkM);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        getSupportActionBar().setTitle("Pan Card Details");
        toolbarkM.setTitleTextColor(getResources().getColor(R.color.colorWhite));
        viewPagerkm=(ViewPager)findViewById(R.id.viewPagerpandetail);
        ...
        linearoutfooter2.setOnClickListener(v -> shrelink());
...
//                startActivity(intent);
        ...
        tabLayoutkm=(TabLayout)findViewById(R.id.tabLayoutpandetail);
    ...
    private void shrelink() {
        AlertDialog.Builder builder=new AlertDialog.Builder(PanCardDetailActivity.this);
        builder.setMessage("Share Joinig Link");
        builder.setPositiveButton("Left", (dialog, which) -> {
        ...
        builder.setNegativeButton("Right", (dialog, which) -> {
            Intent sharingIntent = new Intent(Intent.ACTION_SEND);
            sharingIntent.setType("text/plain");
    ...
    private void setupViewPager(ViewPager viewPager) {
        PanCardDetailActivity.ViewPagerAdapter adapter = new ViewPagerAdapter(getSupportFragmentManager());
        adapter.addFrag(new PanCardDetailFragment(), "");
...
//            this.finish();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(PanCardDetailActivity.this, DashBoard.class);
